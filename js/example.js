const { Gateway } = require('../'); // require('@aegonplatfrm/gateway-pub-example')
...
(async () => {
  ...
  let result = await gateway.getFeesList('BTC');
  console.log('getFeesList =', result);
  result = await gateway.getNewAddress('BTC', false, customer);
